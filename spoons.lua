...
M.Install:andUse('MouseCircle', {config={color=hs.drawing.color.x11.red}, disable=false, hotkeys={show={hyper, 'm'}}})
...
installLog('MouseFollowsFocus')
M.Install:andUse('MouseFollowsFocus', {start=true})
