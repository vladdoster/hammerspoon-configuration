...
local _canvas = canvas
    .new({ h = 42 })
    :appendElements({
        {
            id = 'background',
            type = 'rectangle',
            fillColor = { alpha = 0.7, white = 0.5 },
...
module.registered = function() return settings.get(USERDATA_TAG) end

return { element = _canvas, source = module, frameDetails = { y = 0, cX = '.5', id = 'applications' } }
