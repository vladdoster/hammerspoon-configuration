    ...
    if shouldRecordContents() and theClipping then
        ...
        if theHistory.hashed[hashValue] then
            ...
            while overage > 0 do
                ...
                for k, _ in pairs(theHistory.hashed) do
                    theHistory.hashed[k] = theHistory.hashed[k] - 1
                end
    ...
    if not eventtap.checkMouseButtons().right then
        ...
        if #primaryClipHistory.history == 0 then
            ...
            table.insert(results, {
                title = stext.new(
                    'Hold down '
                        .. utf8.registeredKeys.alt
                        .. ' to '
                        .. utf8.registeredKeys.leftDoubleQuote
                        .. 'type'
            ...
            for i = #primaryClipHistory.history, 1, -1 do
                local itemTitle = (#primaryClipHistory.history[i] > labelLength)
                        and primaryClipHistory.history[i]:sub(1, labelLength) .. ' ' .. utf8.codepointToUTF8('U+2026')
                    or primaryClipHistory.history[i]
        ...
        table.insert(
            results,
            { title = 'Save history now', fn = function() saveHistoryAndSettings(primaryClipHistory) end }
        )
    end
